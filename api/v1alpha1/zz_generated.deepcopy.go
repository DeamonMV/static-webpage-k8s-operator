...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StaticSpecIngress) DeepCopyInto(out *StaticSpecIngress) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StaticSpecIngress.
func (in *StaticSpecIngress) DeepCopy() *StaticSpecIngress {
	if in == nil {
		return nil
	}
	out := new(StaticSpecIngress)
	in.DeepCopyInto(out)
	return out
}
